      ...
      <div class="cart-product">
        <div class="item1">
          <div class="product-img">
            ...
            <div class="box">
                <p class="title">이뮨 멀티비타민&미네랄<br><p class="content">국내 판매 1위 멀티비타민 이뮨 14일분에 이중제형 + 남/녀 맞춤설계 포뮬러를 적용한 신제품</p></p>
                <ul class="txt">
                  <li class="saletxt">GIFTS카드 추가 10% 할인<br>GiftsMall 포인트 최대 1% 적립</li>
                  <li class="prtxt">2,500원 (20,000원 이상 무료배송)</li>
                  <li><p class="strike-line">75,000원</p>가격: 65,000원</li>
                </ul>
            </div>
        </div>
        <div class="item1">
        ...
        <div class="price-box">
          <div class="mini-item">
            <div class="mini-product-img">
              ...
              <div class="mini-box">
                  <p class="mini-title">이뮨 멀티비타민&미네랄</p>
                  <ul class="mini-txt">
                    <li><p class="strike-line mr10">75,000원</p>가격: 65,000원</li>
                  </ul>
              </div>
          </div>
        </div>
        <div class="bcbtn">
          <a href="#" class="q btb">구매하기</a>
          <a href="#" class="q bty">구매하기</a>
          <!-- <button class="no-member open">비회원구매</button> -->
        </div>
      </div>
    </div>
  </section>
